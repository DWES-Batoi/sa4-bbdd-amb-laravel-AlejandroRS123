...
<form action="{{ route('equips.update', $equip) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
    ...
    <div>
        <label class="block text-sm font-medium">Estadio</label>
    ...
    <div>
        <label class="block text-sm font-medium">Títulos</label>
    ...
    <div class="flex items-center gap-3">
        ...
        <p class="text-sm text-gray-600">Escudo actual</p>
    </div>
    @endif
    <div>
        <label class="block text-sm font-medium">Nuevo escudo (opcional)</label>
